...
\klasifikacija{55U10}
\kljucnebesede{Končni topološki prostori, šibka homotopska ekvivalenca, homotopska ekvivalenca, delno urejene množice, simplicialni kompleksi, grafi, sfere} % navedite nekaj ključnih pojmov, ki nastopajo v delu
\keywords{Finite topological spaces, weak homotopy equivalence, homotopy equivalence, partialy orderred sets, simplicial complexes, graphs, spheres} % angleški prevod ključnih besed
